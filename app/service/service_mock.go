...
func (svc *MockService) UpdateTransaction(ctx context.Context, tx models.Transaction, entryDtos []models.CreateTransactionEntryDto) (*models.Transaction, error) {
	args := svc.Called(ctx, tx, entryDtos)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*models.Transaction), args.Error(1)
